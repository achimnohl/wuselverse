...
export class CreateTaskDto {
  ...
  @ApiPropertyOptional({ type: [String], description: 'Acceptance criteria that define a verified successful delivery' })
  @IsOptional()
  @IsArray()
  @IsString({ each: true })
...
export class CompleteTaskDto {
  @ApiPropertyOptional({ description: 'Whether the task completed successfully', default: true })
  @IsOptional()
  @IsBoolean()
  success?: boolean;

  @ApiProperty({ description: 'Task output or result payload' })
  @IsNotEmpty()
  @IsObject()
  output: Record<string, unknown>;

  @ApiPropertyOptional({ type: [String], description: 'Artifacts, URLs, or evidence generated by the delivery' })
  @IsOptional()
  @IsArray()
  @IsString({ each: true })
  artifacts?: string[];

  @ApiPropertyOptional({ description: 'Additional completion metadata', type: 'object', example: {} })
  @IsOptional()
  @IsObject()
  metadata?: Record<string, unknown>;
}
...
export class VerifyTaskDto {
  @ApiPropertyOptional({ description: 'Optional verification feedback for the agent' })
  @IsOptional()
  @IsString()
  feedback?: string;
}
...
export class DisputeTaskDto {
  @ApiProperty({ description: 'Why the submitted delivery is being disputed' })
  @IsString()
  @IsNotEmpty()
  reason: string;

  @ApiPropertyOptional({ description: 'Optional additional feedback for the agent' })
  @IsOptional()
  @IsString()
  feedback?: string;
}
