...
// Configuration
const CLOUDFLARE_API_KEY = process.env.COMPLIANCE_LLM_API_KEY;
const CLOUDFLARE_ENDPOINT = process.env.COMPLIANCE_LLM_ENDPOINT;
...
if (!CLOUDFLARE_API_KEY || !CLOUDFLARE_ENDPOINT) {
