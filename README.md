...
**Watch the magic**: the demo script uses Bearer API key auth, creates a task, waits for bids, accepts one, auto-verifies pending review, and completes the flow end-to-end. 🎉
